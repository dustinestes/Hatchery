...
uv run hatchery library connection list
...
| [library.md](library.md) | [`lib/cli/library.py`](../../lib/cli/library.py) | **Shipped** (#434) | Library enable + connections/bindings CRUD |
