...
4. Demo seeding uses a separate sample catalog repo ([#315](https://github.com/dustinestes/Hatchery/issues/315) `hatchery_catalog`) that operators **add as a Forge connection** - still consume-only.
