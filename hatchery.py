...
# Hatch lifecycle lives in lib.hatch_lifecycle; aliases keep tests / routes stable.
_provisioning = hatch_lifecycle_lib._provisioning
_provisioning_lock = hatch_lifecycle_lib._provisioning_lock
_run_hatch_session = hatch_lifecycle_lib.run_hatch_session
_send_boot_key = hatch_lifecycle_lib.send_boot_key
...
def _sync_hatch_status() -> None:
    """Advance hatch sessions; resolve Nest providers via this module's ``_provider``."""

    def _provider_for(nest_id: str):
        try:
            return _provider(nest_id)
        except (NoNestSelectedError, UnknownNestError, UnsupportedProviderError):
            return None

    hatch_lifecycle_lib.sync_hatch_status(provider_for=_provider_for)


_BOOT_KEY_POLL_ATTEMPTS = hatch_lifecycle_lib._BOOT_KEY_POLL_ATTEMPTS
_BOOT_KEY_SETTLE_SECONDS = hatch_lifecycle_lib._BOOT_KEY_SETTLE_SECONDS
_BOOT_KEY_BURST_ATTEMPTS = hatch_lifecycle_lib._BOOT_KEY_BURST_ATTEMPTS
_BOOT_KEY_BURST_INTERVAL = hatch_lifecycle_lib._BOOT_KEY_BURST_INTERVAL
...
def hatch_clutch_post():
    ...
    hatch_lifecycle_lib.create_and_start_hatch(
