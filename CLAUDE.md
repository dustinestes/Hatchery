...
A local web application for creating, provisioning, and managing VMs. **Host plane** runs on Linux / macOS / Windows; **Nest plane** is libvirt / UTM / Hyper-V (local or remote). Built Windows-guest-first in v1. Architecture: [`docs/architecture-nests.md`](docs/architecture-nests.md).
